...
while True:
    with mp_face_mesh.FaceMesh(
        ...
        cv2.putText(image,f"YAW: {theta_lr:.0f}", (20,80), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255,0,0), 2)
        cv2.putText(image,f"ROLL: {theta_lu:.0f}", (20,120), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,255,0), 2)
        cv2.putText(image,f"PITCH: {theta_du:.0f}", (20,160), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,0,255), 2)
